...
rc=1./(2*r_area*d(:,1)*abs(delta_f(end)));
data=[d(:,1) rc rf]
...
plot(rc(1:end),(d(1:end,2)-omega_inf)/abs(delta_f(end)),'o-',rc(1:end) ,(d(1:end,3)-omega_inf)/abs(delta_f(end)),'^-')
